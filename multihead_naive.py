...
if __name__ == "__main__":
    ...
    mha_naive = MultiHeadAttentionWrapper(d_in, d_out, context_length, 0.0, 2)
    #causal_attention = CausalAttention(d_in, d_out, context_length, 0.0)
    mha_context_vector = mha_naive(batch)
    print("mha_context_vector_naive.shape:", mha_context_vector.shape)
    print(mha_context_vector)
